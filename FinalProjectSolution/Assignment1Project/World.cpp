...
void World::buildScene()
{
	...
	std::unique_ptr<SpriteNode> plane1(new SpriteNode(SpriteNode::Desert, mGame));
	...
	std::unique_ptr<SpriteNode> plane2(new SpriteNode(SpriteNode::Desert, mGame));
	...
	std::unique_ptr<SpriteNode> plane3(new SpriteNode(SpriteNode::Desert, mGame));
